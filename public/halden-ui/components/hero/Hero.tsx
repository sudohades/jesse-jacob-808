    ...
    >
      ...
      <Container className={cn("relative py-24 sm:py-32", align === "center" && "text-center")}>
        <div className={cn("flex flex-col gap-8", align === "center" && "items-center")}>
          ...
          {meta && <div className="hd-font-mono mt-6 flex flex-wrap items-center gap-x-6 gap-y-2 text-[11px] tracking-[.14em] uppercase text-[var(--color-muted-foreground)]">{meta}</div>}
        </div>
      </Container>
    </section>
  );
