# TODO — Premium Editorial Redesign

- [x] Step 1: Add editorial primitives under `src/components/site/primitives/`.

- [x] Step 2: Refactor `app/globals.css` to reduce glass/ornament and disable non-essential motion.

- [x] Step 3: Update navigation/header/footer/shell to a quieter architectural frame.
